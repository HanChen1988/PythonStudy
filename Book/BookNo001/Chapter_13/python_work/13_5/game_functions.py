...
def check_footballs_bottom(ai_settings, screen, grass, footballs):
    """检查是否有足球到达了屏幕底端"""
...
def update_footballs(ai_settings, screen, grass, footballs):
    """
    更新整群足球的位置
    """
    footballs.update()
    ...
    # 检查是否有足球到达屏幕底端
    check_footballs_bottom(ai_settings, screen, grass, footballs)
# ------------------ example01 ------------------
